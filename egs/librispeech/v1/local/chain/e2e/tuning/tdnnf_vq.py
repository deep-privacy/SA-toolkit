...
import pkwrap
from pkwrap.nn import TDNNFBatchNorm, NaturalAffineTransform, OrthonormalLinear, VectorQuantizerEMA, TDNNFBatchNorm_VQ
...
class Net(nn.Module):
    ...
    def __init__(self,
        ...
        self.prefinal_chain_vq = TDNNFBatchNorm_VQ(
