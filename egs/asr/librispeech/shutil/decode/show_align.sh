...
model="shutil/decode/chain/e2e/tuning/tdnnf_vq.py  --codebook-size 16"
exp_dir="exp/chain/e2e_tdnnf_vq_sizeco_16/"

# model="shutil/decode/chain/e2e/tuning/tdnnf.py"
...
python3 shutil/decode/convert_ctm.py -i $TMPFILE/align.ctm \
...
python3 shutil/decode/convert_ctm.py -i $TMPFILE/phone_alined.ctm \
...
python3 ./shutil/decode/map_kaldi_transitionids.py --input $TMPFILE/transids.txt --input_transitions $TMPFILE/transitions.txt --output $TMPFILE/out_state_seq
