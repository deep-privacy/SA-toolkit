...
"""
ioTools FROM: https://github.com/nii-yamagishilab/project-CURRENNT-public/tree/master/pyTools
"""
...
def list_file_name_in_dir(fileDir):
    ...
    """
    return [
        os.path.splitext(x)[0] for x in os.listdir(fileDir) if not x.startswith(".")
    ]
